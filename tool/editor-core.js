...
export const PRESET_TEMPLATES = {
    list: [
        ...
        { type: 'table', name: '表格区', title: '表格', text: '列1 ｜ 列2 ｜ 列3 ｜ 列4', x: 204, y: 188, width: 720, height: 420 },
        { type: 'pagination', name: '分页', title: '分页', text: '上一页 1 2 3 下一页', x: 704, y: 624, width: 220, height: 36 },
    ],
    dashboard: [
        { type: 'sidebar', name: '左侧侧边栏', title: '侧边栏', text: 'LOGO\n总览\n统计\n分析', x: 0, y: 0, width: 180, height: 720 },
        { type: 'breadcrumb', name: '面包屑', title: '面包屑', text: '首页 / Dashboard', x: 204, y: 24, width: 240, height: 32 },
        { type: 'title', name: '标题', title: 'Dashboard 标题', text: '经营概览', x: 204, y: 64, width: 240, height: 48 },
        { type: 'card', name: '卡片', title: '指标卡1', text: '总订单\n1,024', x: 204, y: 136, width: 168, height: 112 },
        { type: 'card', name: '卡片', title: '指标卡2', text: 'GMV\n¥128,000', x: 388, y: 136, width: 168, height: 112 },
        { type: 'card', name: '卡片', title: '指标卡3', text: '新增用户\n256', x: 572, y: 136, width: 168, height: 112 },
        { type: 'card', name: '卡片', title: '指标卡4', text: '转化率\n37%', x: 756, y: 136, width: 168, height: 112 },
        { type: 'table', name: '表格区', title: '趋势/列表', text: '列1 ｜ 列2 ｜ 列3 ｜ 列4', x: 204, y: 280, width: 720, height: 328 },
    ],
    form: [
        { type: 'breadcrumb', name: '面包屑', title: '面包屑', text: '首页 / 表单页', x: 96, y: 32, width: 240, height: 32 },
        { type: 'title', name: '标题', title: '表单页标题', text: '创建用户', x: 96, y: 72, width: 240, height: 48 },
        { type: 'card', name: '卡片', title: '表单容器', text: '基础信息', x: 96, y: 144, width: 768, height: 400 },
        { type: 'input', name: '输入框', title: '姓名', text: '请输入姓名', x: 136, y: 208, width: 280, height: 44 },
        { type: 'select', name: '下拉框', title: '角色', text: '请选择角色', x: 448, y: 208, width: 280, height: 44 },
        { type: 'datePicker', name: '日期选择', title: '日期', text: '选择日期', x: 136, y: 280, width: 280, height: 44 },
        { type: 'text', name: '文本', title: '备注', text: '备注说明区域', x: 136, y: 352, width: 592, height: 88 },
        { type: 'button', name: '按钮', title: '提交按钮', text: '提交', x: 608, y: 472, width: 120, height: 40 },
    ],
    detail: [
        { type: 'breadcrumb', name: '面包屑', title: '面包屑', text: '首页 / 详情页', x: 96, y: 32, width: 240, height: 32 },
        { type: 'title', name: '标题', title: '详情页标题', text: '订单详情', x: 96, y: 72, width: 240, height: 48 },
        { type: 'card', name: '卡片', title: '基础信息卡片', text: '基础信息', x: 96, y: 144, width: 768, height: 168 },
        { type: 'text', name: '文本', title: '详情字段1', text: '订单号：202603240001', x: 128, y: 184, width: 280, height: 40 },
        { type: 'text', name: '文本', title: '详情字段2', text: '状态：处理中', x: 448, y: 184, width: 240, height: 40 },
        { type: 'card', name: '卡片', title: '日志卡片', text: '处理日志', x: 96, y: 336, width: 768, height: 240 },
        { type: 'table', name: '表格区', title: '日志表格', text: '时间 ｜ 动作 ｜ 操作人 ｜ 备注', x: 128, y: 384, width: 704, height: 160 },
    ],
};
